...
const Navbar = () => {
  ...
  return (
    <>
      <SlideComp className="fixed container top-0 z-30 bg-[#222] text-white w-full flex justify-center items-center rounded-b-3xl">
        <nav className="p-5 w-full">
          ...
          <ul className="hidden md:flex gap-10 justify-center">
            ...
            <LinkComponent link="portfolio" name="Portfolio" onClick={handleClose} />
            <LinkComponent link="contact" name="Contact" onClick={handleClose} />
          </ul>
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.ul
                className="flex flex-col items-center gap-5 mt-5 md:hidden"
